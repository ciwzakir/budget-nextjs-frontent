...
const ReturnAsPerCompanyPage = () => {
  ...
  let summaryYearlyReturnAsperCompany: any[] = [];
  ...
  const pageCount = async (): Promise<number> => {
    if (summaryYearlyReturnAsperCompany?.length >= 0) {
      await summaryYearlyReturnAsperCompany;
      return summaryYearlyReturnAsperCompany.length;
    }
    return 0;
  };
