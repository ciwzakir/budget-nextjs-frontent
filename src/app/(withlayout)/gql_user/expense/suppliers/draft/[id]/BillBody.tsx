...
import { convertNumberToWordsEN } from "@/app/(withlayout)/gql_user/products/utils/convertNumberToWords";

const amount1: number = 992345678;
  ...
  return (
    <Suspense fallback={<Spin />}>
      <div style={{ margin: "10px 0" }}>
        ...
        <p> In words : {convertNumberToWordsEN(amount1)} </p>
      </div>
    </Suspense>
  );
};
